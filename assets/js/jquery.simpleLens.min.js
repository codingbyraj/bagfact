        ...
        var d = c.extend({}, c.fn.simpleLens.defaults, l)
            ...
            , e = {
                ...
                , update_cursor_position: function (a, b) {
                    var c = b - this.height_center
                        ...
                        , g = h.limits;
                    parseFloat(g.y_top) > parseFloat(c) ? c = g.y_top : parseFloat(d) > parseFloat(g.y_bottom) && (c = g.y_bottom - this.cursor_height);
                    parseFloat(g.x_left) > parseFloat(e) ? e = g.x_left : parseFloat(f) > parseFloat(g.x_right) && (e = g.x_right - this.cursor_width);
                    this.cursor_position = {
                        top: c
                        , left: e
            ...
            , k = {
                init: function (a) {
                    ...
                    this.lens_container = c("<div>", {
                        "class": d.lens_class
                    });
                    this.lens_image = c("<img>");
                    h.init(a.find(d.big_image_class));
                    void 0 === this.lens_image_url && (f("Cannot find lens image. URL: " + this.lens_image_url), f(that), f(a), f(lens_image_url))
                }
                ...
                , lens_event_bind: function () {
                    ...
                    this.parent_anchor.mousemove(function (b) {
                        ...
                        a.update_lens_position(a.calc_lens_position(e.cursor_position, a.ratio, a.container))
                    })
                }
                ...
                , destroy: function () {
                    e.destroy();
                    void 0 !== this.lens_container && 0 < this.lens_container.length && (c("." + d.lens_class).remove(), this.lens_event_unbind())
                }
                , load: function (a) {
                    var b = this;
